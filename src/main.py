...
if __name__ == "__main__":
    ...
    ZMQ_serv = ZMQserver(4000, 4001, debug=True)
    ZMQ_serv.start()
    ...
    for mmsi in mmsis:
        ...
        new_client = Client(str(mmsi), KGC_dict[KGC_id], KGC_id, LO_url, debug=True, cleanup=True)
        new_client.setup()
    ...
    for i in range(20):
        ...
        print(f"Sending : {client.ID}, {client.topic}")
